...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center w-9 h-9 rounded-lg border border-border text-text-muted hover:text-text hover:bg-surface-hover transition-colors"
    >
      {isDark ? (
